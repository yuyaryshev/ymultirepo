...
function getLocalPackagesPathsObj() {
...
function writeFileSyncIfChanged(fileName, content, encoding = "utf-8") {
    let current;
    try {
...
function getLocalPackagesList(localPackagesPaths = getLocalPackagesPathsObj()){
...
function ymultirepoScan(localPackagesPaths = getLocalPackagesPathsObj()) {
...
function getLocalPackages(localPackagesPaths = getLocalPackagesPathsObj()) {
...
function ymultirepoRemap(p, context, effectiveLocalPackages = getLocalPackages()) {
...
module.exports = {
    caseInsensitiveCompare, getLocalPackagesPathsObj, writeFileSyncIfChanged, getLocalPackagesList, ymultirepoScan, getLocalPackages, ymultirepoRemap
};